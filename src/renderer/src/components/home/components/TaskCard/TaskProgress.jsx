...
// const TaskProgress = ({ val, defaultColor = '#E4E4E4' }) => {
...
//     const totalTime = Math.max(val.total_time, val.total_time_spent_by_user)
//     const timeValues = [
...
//     // Create the progressData object
//     const progressData = {}
...
//     .map((color) => Math.max(0, Math.min(progressData[color], 100)))
//     .sort((a, b) => b - a)
...
//         const percentage = progressData[color].toFixed(2)
...
//             placement="top"
//             followCursor
//             speaker={<Tooltip>{`${percentage}%`}</Tooltip>}
//           >
//             <rect
//               width={width || 0}
//               height="12"
